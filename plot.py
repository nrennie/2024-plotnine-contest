...
# annotation labels
coal_types_label='Total coal production includes\nproduction of <Bituminous::{"color": "#E58606"}>,\n<Sub-bituminous::{"color": "#5D69B1"}>, <Metallurgical::{"color": "#52BCA3"}>, <Lignite::{"color": "#99C945"}>,\n<Anthracite::{"color": "#CC61B0"}>, and <Thermal::{"color": "#24796C"}> coal.\nBituminous accounts for\naround half.'

# caption
cap='<Data::{"fontweight": "bold"}>: Carbon Majors\n<Graphic::{"fontweight": "bold"}>: Nicola Rennie (GitHub: @nrennie)'
...
# Add styled text with matplotlib and HighlightText
fig=p.draw()
fig.set_size_inches(16, 12, forward=True)
fig.set_dpi(300)
ax=plt.gca()
ht.ax_text(1977, 9400, coal_types_label, vsep=3, color=text_col, fontname=body_font, fontsize=9, va='top')
ht.ax_text(1900, -2300, cap, color=text_col, fontname=body_font, fontsize=7.5, va='top')
plt.show()
