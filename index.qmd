...
Instead, of `"red"` we can use our different hex colours. We'll also add some text formatting to the caption in a similar way. Instead of colouring the text, we'll make some of it bold. Therefore, we use `"fontweight": "bold"` instead of `"color": "red"`:
...
If you want to save as a PNG, you can use `plt.savefig()`:
